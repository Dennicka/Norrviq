...
def upgrade() -> None:
    ...
    op.bulk_insert(
        ...
        [
            ...
            dict(is_active=True, entity='PROJECT', field='rooms_count', rule_type='MIN_MAX', min_value=1.00, max_value=150.00, severity='WARNING', message_ru='Слишком много комнат в проекте. Проверьте структуру.', message_sv='Mycket många rum i projektet.'),
            dict(is_active=True, entity='PROJECT', field='work_items_count', rule_type='MIN_MAX', min_value=1.00, max_value=1000.00, severity='WARNING', message_ru='Очень много работ. Возможно, дублирование позиций.', message_sv='Väldigt många arbetsposter.'),
            dict(is_active=True, entity='PROJECT', field='work_items_count', rule_type='MIN_MAX', min_value=1.00, max_value=5000.00, severity='BLOCK', message_ru='Критично: число работ выглядит ошибочным (>5000).', message_sv='Kritiskt: antal arbetsposter verkar fel (>5000).'),

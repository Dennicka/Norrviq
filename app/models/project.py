...
class ProjectWorkItem(Base):
    ...
    basis_type = Column(String(32), nullable=False, default="floor_area_m2", server_default="floor_area_m2")
    selected_room_ids_json = Column(Text, nullable=True)
    manual_qty = Column(Numeric(12, 2), nullable=True)
    calculated_qty = Column(Numeric(12, 2), nullable=False, default=0, server_default="0")
    ...
    calculated_sell_ex_vat = Column(Numeric(12, 2), nullable=False, default=0, server_default="0")
    calculated_labour_cost_ex_vat = Column(Numeric(12, 2), nullable=False, default=0, server_default="0")
